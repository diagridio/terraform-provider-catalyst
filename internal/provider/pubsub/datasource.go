...
var _ datasource.DataSource = &pubsubDataSource{}
...
func (d *pubsubDataSource) Metadata(ctx context.Context,
...
func (d *pubsubDataSource) Schema(ctx context.Context,
	req datasource.SchemaRequest,
	resp *datasource.SchemaResponse,
) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PubSub data source",
...
func (d *pubsubDataSource) Configure(ctx context.Context,
...
func (d *pubsubDataSource) Read(ctx context.Context,
	...
	if err := read(ctx, d.client, model); err != nil {
		resp.Diagnostics.AddError("Client Error",
			fmt.Sprintf("error reading pubsub datasource: %s", err))
		return
	}
